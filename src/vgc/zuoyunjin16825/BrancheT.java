 ...
 * @ZuoyunJin16825
 */
public class BrancheT extends javax.swing.JFrame implements ProgramInterface{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrancheT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
