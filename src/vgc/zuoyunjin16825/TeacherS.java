 ...
 * @ZuoyunJin16825
 */
public class TeacherS extends javax.swing.JFrame implements ProgramInterface{
    ...
    public ArrayList<teacherData> teacherList() {
        ...
        String sql = "Select Faculty.FacultyFName,Faculty.FacultyLName,Courses.CoursesName from ((Timetable INNER JOIN Faculty ON Timetable.FacultyID = Faculty.FacultyID) INNER JOIN Courses ON Timetable.CoursesID = Courses.CoursesID)";
        ...
        try {
            ...
            while (myRs.next()) {
                ...
                teacherDataTable = new teacherData(myRs.getString("FacultyFName"), myRs.getString("FacultyLName"), myRs.getString("CoursesName"));
    ...
    public void showTeacherData() {
        ...
        for (int i = 0; i < list.size(); i++) {
            row[0] = list.get(i).getFFN();
            row[1] = list.get(i).getFLN();
            row[2] = list.get(i).getCSN();
            model.addRow(row);
        }
    }
